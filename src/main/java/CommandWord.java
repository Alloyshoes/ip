...
public enum CommandWord {
    ...
    CommandWord(String usage, String description) {
        this.usage = usage;
    ...
    /**
     * Looks up the command word matching the given text (case-insensitive).
     *
     ...
     */
    public static CommandWord fromWord(String word) throws EveException {
        try {
